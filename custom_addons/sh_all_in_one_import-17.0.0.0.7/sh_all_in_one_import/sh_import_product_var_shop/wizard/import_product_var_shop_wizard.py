                        ...
                        try:
                            ...
                            if row[0] not in (None,
                                ...
                                if row[0] != running_tmpl:
                                    ...
                                    if row[3].strip() not in (None, "") and row[2].strip() == 'FALSE':
                                        can_be_sold = False
                                        tmpl_vals.update({
                                            'purchase_ok': can_be_sold,
                                        })
                                    elif row[3].strip() not in (None, "") and row[2].strip() == 'TRUE':
                                        can_be_sold = True
                                        tmpl_vals.update({
                                            'purchase_ok': can_be_sold,
                                        })
...
# ================================
                                    ...
                                    if row[14] not in (None, "",0,0.0,'0','0.0'):
                                        tmpl_vals.update(
                                    ...
                                    # =====================================================
                                    if row[16].strip() not in (None, "") and row[2].strip() == 'FALSE':
                                        tmpl_vals.update(
                                            {'is_published': False})
                                    elif row[16].strip() not in (None, "") and row[2].strip() == 'TRUE':
                                        tmpl_vals.update(
                                            {'is_published': True})
